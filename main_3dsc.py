...
filename='../MP/3DSC_MP.csv'
csv=pd.read_csv(filename, skiprows=[0], on_bad_lines='skip')
label=csv.pop('tc')
labels=np.array(label)

# folder_path='/work/mroitegui/Superconductivity/shap'
##########
formula = pd.read_csv(filename, skiprows=[0], on_bad_lines='skip')
electrones=pd.read_csv("data/periodic_table_of_elementswithelectronstotal.csv")
superconductors_list=formula['formula_sc'].tolist()
#########
#########
#FEATURES#
